        ...
        <Card.Body>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group id="dob">
              ...
              <Form.Control type="date" value = {dateState} onChange = {(e)=> dateWork(e.target.value)} required />
              <Form.Text className="text-muted">
            ...
            <Form.Row id="sex">
              ...
              <Form.Control as="select" value={optionsState} onChange = {(e) => setOptionsState(e.target.value)} required>
            ...
            <Form.Row id="sexualOrientation">
              ...
              <Form.Control as="select" value={orientationState} onChange = {(e) => setOrientationState(e.target.value)} required>
            ...
            <Form.Group id="customResponse">
              ...
              <Form.Text className="text-muted">
                Users will see this response at the end of a chat. This can be changed later...
              </Form.Text>
            </Form.Group>
            <Form.Group id="phoneGroup">
              <Form.Label>Phone number:</Form.Label>
              <Form.Control type="tel" value={phoneVal} onChange={(e)=> phoneWork(e)} required/>
            </Form.Group>
